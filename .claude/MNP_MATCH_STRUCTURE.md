# MNP Match Structure Reference

**Purpose**: This document provides detailed information about Monday Night Pinball match structure and JSON data formats. This is reference material for LLMs analyzing MNP data.
...
Match files are located in `mnp-data-archive/season-XX/matches/` and follow this naming convention:
- Format: `mnp-{season}-{week}-{away_team}-{home_team}.json`
- Example: `mnp-21-1-ADB-JMF.json` (Season 21, Week 1, Add-a-Ballers @ Jupiter Morning Folks)
...
**For**: LLM context when analyzing MNP match data
